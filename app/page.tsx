...
const handleDragEnd = (_: any, info: any) => {
  ...
  return (
    <main 
      ref={containerRef} 
      className="relative min-h-screen bg-[#0d0e10] text-slate-100 selection:bg-cyan-500/30 font-sans scroll-smooth cursor-none overflow-x-hidden"
    >
      <SpiritCursor />
      <Fireflies />
      ...
      <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-[2]">
        ...
        >
          <img 
            src="/yggdrasil.png" 
            className="w-[85vw] md:w-[35vw] h-auto object-contain drop-shadow-[0_0_100px_rgba(34,211,238,0.3)]" 
            alt="Yggdrasil" 
          />
        </motion.div>
      </div>
      ...
      >
        <div className="absolute top-12 left-12 flex items-center gap-4">
          <span className="[writing-mode:vertical-rl] text-[10px] tracking-[0.5em] opacity-30 uppercase font-mono">
            Computer Science
          </span>
          <div className="text-xl md:text-3xl font-serif italic tracking-tighter opacity-90">
            Syafiq Hamdani
          </div>
        </div>
        ...
        >
          <motion.h2 
            ...
            className="text-[10vw] md:text-[12vw] font-black leading-none tracking-tighter opacity-10 uppercase select-none relative z-10"
          >
            Portfolio
          </motion.h2>
          ...
          >
            <span className="text-cyan-400 font-mono text-sm tracking-widest bg-cyan-900/40 px-3 py-1 rounded-sm border border-cyan-400/20">
              西暦 2026
            </span>
          </motion.div>
          ...
          <motion.h2 
            style={{ opacity: heroTextOpacity }} 
            variants={itemVariants} 
            className="text-[10vw] md:text-[12vw] font-black leading-none tracking-tighter opacity-10 uppercase select-none relative z-30 mt-[-6vh] md:mt-[-12vh] md:ml-[35vw]"
          >
            2026
          </motion.h2>
        </motion.div>

        <div className="absolute bottom-0 w-full h-[35vh] flex justify-center items-end overflow-hidden">
          <motion.div 
      ...
      <motion.section 
        ...
        variants={containerVariants} 
        className="py-40 px-6 max-w-7xl mx-auto flex flex-col items-center z-10 relative"
      >
        {/* Decorative Japanese Character */}
        <div className="absolute -left-10 top-40 text-cyan-500/10 text-[20vw] font-black select-none pointer-events-none">
          私
        </div>

        <motion.h1 
          variants={itemVariants} 
          className="text-7xl md:text-8xl font-black mb-2 tracking-tighter text-white uppercase text-center"
        >
          SYAFIQ HAMDANI
        </motion.h1>
        ...
        <motion.p 
          variants={itemVariants} 
          className="text-cyan-400 font-mono tracking-[0.3em] mb-20 text-sm uppercase text-center"
        >
        ...
        <div className="relative w-full flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
          <motion.div 
            variants={itemVariants} 
            className="flex-1 bg-[#1a1c1e]/80 backdrop-blur-xl p-12 md:p-20 rounded-[2rem] border border-white/5"
          >
            <h3 className="text-sm font-mono tracking-[0.5em] text-cyan-400 mb-6 uppercase">
              About / 自己紹介
            </h3>
      ...
      <motion.section 
        ...
        variants={containerVariants} 
        className="py-32 relative bg-black/20"
      >
        <div className="max-w-7xl mx-auto px-6">
          <motion.h2 
            variants={itemVariants} 
            className="text-[12vw] font-black text-center mb-12 text-white tracking-tighter uppercase"
          >
            RECENT
          </motion.h2>
          ...
          <motion.div 
            variants={itemVariants} 
            className="sticky top-24 z-40 flex justify-center mb-20 w-fit mx-auto"
          >
          ...
          <AnimatePresence mode="wait">
            {activeTab === "Project" && (
              ...
              >
                ...
                <motion.div 
                  variants={itemVariants} 
                  className="group bg-[#242628] rounded-3xl p-10 border border-white/5 flex flex-col justify-center items-center text-center hover:border-emerald-500/50 transition-all"
                >
                  <h4 className="text-3xl font-bold">Portfolio 2026</h4>
                  <p className="text-emerald-400 font-mono text-xs mt-3 uppercase tracking-widest">
                    Ongoing
                  </p>
              ...
              >
                {skills.map(skill => (
                  ...
                  >
                    ...
                    <span className="mt-4 text-xs font-bold tracking-widest text-slate-500 group-hover:text-white uppercase">
                      {skill.name}
                    </span>
                  </motion.div>
                ))}
              ...
              >
                {Array.from({ length: 15 }).map((_, i) => (
                  <motion.div 
                    ...
                    className="aspect-video bg-[#242628] rounded-2xl border border-white/5 flex items-center justify-center group relative overflow-hidden shadow-lg hover:border-cyan-500/50 transition-all cursor-pointer"
                  >
                    <img 
                      src={`/cert-${i + 1}.png`} 
      ...
      <motion.section 
        ...
        viewport={{ once: true, amount: 0.2 }} 
        variants={containerVariants} 
        className="py-40 max-w-5xl mx-auto px-6"
      >
        <motion.h2 
          variants={itemVariants} 
          className="text-7xl font-black mb-20 text-center uppercase tracking-tighter"
        >
          Contact
        </motion.h2>
          ...
          <motion.div variants={itemVariants} className="space-y-10">
            ...
            >
              <input 
                name="name" 
                placeholder="Name" 
                className="w-full bg-white/5 border border-white/10 p-5 rounded-2xl focus:border-cyan-500 outline-none transition-all" 
                required 
              />
              <input 
                name="email" 
              ...
              <button 
                type="submit" 
                className="w-full bg-white text-black font-black py-5 rounded-2xl hover:bg-cyan-400 transition-all uppercase tracking-widest"
              >
                Submit
              </button>
            </form>
          ...
          <motion.div variants={itemVariants} className="space-y-12">
            ...
            <div className="space-y-6">
              <a 
                ...
                className="p-10 bg-[#242628] rounded-3xl flex items-center gap-8 hover:bg-[#2a2c2e] transition-all border border-white/5"
              >
                <div className="w-12 h-12 bg-cyan-600 rounded-lg flex items-center justify-center font-bold text-2xl italic">
                  in
                </div>
                <div>
                  <p className="text-xs opacity-50 font-mono uppercase tracking-widest mb-1">
                    LinkedIn
                  </p>
                  <p className="text-xl font-bold">Lets Connect</p>
                </div>
              </a>
              
              <div className="p-10 bg-[#242628] rounded-3xl flex items-center gap-8 border border-white/5">
                <div className="w-12 h-12 bg-slate-700 rounded-lg flex items-center justify-center font-bold text-lg">
                  Git
                </div>
                <div>
                  <p className="text-xs opacity-50 font-mono uppercase tracking-widest mb-1">
                  ...
                  <p className="text-xl font-bold tracking-tighter">LunaeQuinx</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <AnimatePresence>
        {selectedCert && (
          <motion.div 
            ...
            className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-xl p-4 md:p-20 cursor-zoom-out"
          >
            <motion.div 
              initial={{ scale: 0.8, y: 20 }} 
              animate={{ scale: 1, y: 0 }} 
              exit={{ scale: 0.8, y: 20 }} 
              className="relative max-w-5xl w-full aspect-video rounded-3xl overflow-hidden shadow-[0_0_100px_rgba(34,211,238,0.2)] border border-white/10" 
            ...
            >
              ...
              <button 
                onClick={() => setSelectedCert(null)} 
                className="absolute top-6 right-6 w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white border border-white/10 group"
              >
